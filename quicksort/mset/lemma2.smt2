...
; lemma3: filter_less and filter_ge together cover all elements of the list
; lrs+10_1_drc=encompass:ind=struct:sik=one:to=lpo:sos=theory:sstl=1:sp=occurrence:indao=on_89
(assert-not (par (a)
